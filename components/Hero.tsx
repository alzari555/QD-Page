  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center text-center overflow-hidden bg-[#1d1d1b]">
      ...
      <div className="relative z-10 flex flex-col items-center px-6">
        <img src="../resources/logo web purpura.svg" alt="QD Logo" className="w-64 md:w-96 text-[#993399] animate-pulse-slow" />
        ...
        <p className="mt-6 text-lg md:text-xl max-w-2xl text-gray-300">
          Creamos identidades de marca audaces y experiencias digitales que cautivan y convierten.
        </p>
