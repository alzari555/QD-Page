...
const Socials: React.FC = () => {
  return (
    <section className="pt-12 pb-12 sm:pb-16 bg-[#1d1d1b]">
      <div className="container mx-auto px-6 text-center">
        <div className="flex flex-col sm:flex-row items-center sm:justify-center space-y-4 sm:space-y-0 sm:space-x-6">
